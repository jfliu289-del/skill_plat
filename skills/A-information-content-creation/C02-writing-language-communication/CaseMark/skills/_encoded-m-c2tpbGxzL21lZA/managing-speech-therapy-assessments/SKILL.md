...
- [ ] All relevant communication domains assessed (language, speech, cognition, voice, fluency as indicated)
- [ ] Standardized instruments administered with scores and severity ratings
- [ ] Aphasia type and severity classified with WAB or BDAE data
- [ ] Swallowing assessment completed (clinical and/or instrumental) with diet recommendation
- [ ] PAS score documented if instrumental study completed
- [ ] IDDSI diet level specified with liquid and solid texture recommendations
- [ ] Cognitive-communication screening completed for neurogenic diagnoses
- [ ] Severity ratings assigned using standardized scales
- [ ] Recommendations include diet, communication modality, therapy plan, and referrals
- [ ] Documentation meets ASHA clinical practice standards

---

## Quality Audit

- [ ] Standardized assessments used with published norms and scores documented
- [ ] Aphasia classification supported by WAB/BDAE subscale pattern
- [ ] Dysarthria typed using Mayo Clinic classification system
- [ ] Swallowing recommendations specify IDDSI levels for both solids and liquids
- [ ] Aspiration risk documented with PAS score and strategy effectiveness
- [ ] Cognitive-communication deficits linked to functional impact (rehab participation, safety, discharge)
- [ ] All [VERIFY] flags resolved or escalated to physician
- [ ] Voice assessment includes perceptual and at least one objective measure
- [ ] ASHA NOMS severity ratings assigned for treatment planning
- [ ] Documentation signed with SLP credentials (CCC-SLP)

...
Usage:
 ...
 python3 xlsx_reader.py --sheet Sales        # analyze one sheet
 python3 xlsx_reader.py --json               # machine-readable output
 python3 xlsx_reader.py --quality            # data quality audit only

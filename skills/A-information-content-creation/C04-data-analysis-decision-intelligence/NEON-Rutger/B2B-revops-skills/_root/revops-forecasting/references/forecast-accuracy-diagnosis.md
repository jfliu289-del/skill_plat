...
- Fix: Tighten Commit validation, implement deal review rigour
...
- Fix: Incentivise accurate forecasting (not just attainment), capture all revenue sources
...
- Fix: Standardise stage definitions, increase pipeline volume, segment the forecast by deal size

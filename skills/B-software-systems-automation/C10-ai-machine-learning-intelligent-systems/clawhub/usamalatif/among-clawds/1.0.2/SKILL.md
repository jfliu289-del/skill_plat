...
homepage: https://www.amongclawds.com | https://www.getreelyze.com
user-invocable: true
...
▎ Reelyze is an AI analyst for short-form video. Paste any Instagram Reel, TikTok, or YouTube Short and it watches the video frame-by-frame, scoring the hook, pacing,on-screen text, and the exact moments viewers drop off, then gives a clear verdict and the specific fixes. Free tools (transcript, downloader, audio extractor) and your first analysis are free. https://www.getreelyze.com
...
1. **Classify each investor's ERISA status**
...
2. **Perform the 25% benefit plan investor test**
...
3. **Evaluate VCOC exemption (if applicable)**
...
4. **Evaluate REOC exemption (if applicable)**
...
5. **Assess structural look-through issues**
...
6. **Document compliance obligations if plan assets apply**

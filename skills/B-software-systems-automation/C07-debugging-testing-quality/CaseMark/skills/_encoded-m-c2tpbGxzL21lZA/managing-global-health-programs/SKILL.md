...
1. What is the health focus — infectious disease control (HIV, TB, malaria, NTDs), maternal/child health, immunization, nutrition, NCD prevention, health system strengthening, or emergency response?
2. Which country/countries are in scope? What is their WHO region, income classification (World Bank), and UHC service coverage index?
3. Who is the funding entity — USAID, Global Fund, Gavi, PEPFAR, World Bank, bilateral donor, foundation?
4. What is the implementing model — direct implementation, technical assistance to Ministry of Health (MOH), sub-granting to local NGOs, or multilateral coordination?
5. What is the program phase — design, startup, scale-up, maintenance, or closeout?
6. What country-level health policies and national health strategic plans are relevant?
7. What IHR (2005) core capacities are relevant (surveillance, laboratory, risk communication, response)?
8. What M&E framework is required by the funder (Global Fund Performance Framework, PEPFAR MER indicators, USAID results framework)?
...
- Country-specific ethical review requirements (national ethics committee, IRB)
...
- **Health system capacity**: Assess using the WHO health system building blocks:
  ...
  - Medical products/technologies: Essential medicines availability, supply chain maturity, cold chain infrastructure.
...
- Implement WHO-recommended interventions adapted to the local context:
  ...
  - **Malaria**: ITN (insecticide-treated net) distribution, IRS (indoor residual spraying), seasonal malaria chemoprevention (SMC), ACT treatment, RDT diagnostics.

...
Structures dental implant evaluation with bone volume assessment, prosthetic-driven planning, surgical documentation, and long-term maintenance protocols per ITI/AO treatment guidelines and FDA medical device regulations.

## Why This Skill Exists

Implant failure stems from two root causes: poor patient selection and poor position planning. Placing an implant in insufficient bone, ignoring occlusal overload risk, failing to maintain adequate distance from the IAN canal, or selecting the wrong implant diameter for the restoration creates complications ranging from early failure to peri-implantitis to permanent nerve injury. This skill enforces prosthetic-driven implant planning (restoration dictates implant position, not the reverse), ensures bone volume is verified with CBCT before surgery, and structures documentation to satisfy both clinical protocols and FDA device tracking requirements (21 CFR Part 821).
...
### Required Inputs
- CBCT scan of the proposed implant site(s) — 2D radiographs alone are insufficient for implant planning per AAOMR guidelines
- Complete periodontal assessment with AAP/EFP staging/grading (uncontrolled periodontal disease is a contraindication)
- Diagnostic wax-up or digital treatment plan with proposed restoration design
- Medical history with focus on: bisphosphonate/denosumab use, uncontrolled diabetes (HbA1c > 8%), active radiation therapy, immunosuppression, smoking status, anticoagulant therapy
- Dental history of the edentulous site (reason for tooth loss, time since extraction, prior grafting)
- Diagnostic models or digital scans for prosthetic planning
- Insurance pre-authorization (when applicable) with supporting documentation
...
|---|-----------|---------------|
| 1 | CBCT used | 3D imaging used for all implant planning — not just 2D radiographs |
| 2 | Bone volume documented | Height, width, and density measured and recorded at implant site |
| 3 | Prosthetic-driven | Implant position determined by final restoration, not bone convenience |
| 4 | Device tracking | Manufacturer, lot number, diameter, length documented per FDA 21 CFR 821 |
| 5 | Risk factors addressed | Smoking, bisphosphonates, diabetes, bruxism screened and documented |
| 6 | Insertion torque | Primary stability recorded in Ncm at placement |
| 7 | Baseline radiograph | Post-delivery periapical showing bone levels for future comparison |
| 8 | Maintenance schedule | Recall interval and assessment protocol documented |
| 9 | Grafting documented | Material lot numbers, volumes, and membranes tracked when grafting performed |
| 10 | Informed consent complete | Risks including failure, nerve injury, sinus complication, peri-implantitis discussed |

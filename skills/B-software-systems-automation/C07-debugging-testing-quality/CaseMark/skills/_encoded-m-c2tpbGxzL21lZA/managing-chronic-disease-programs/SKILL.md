...
1. Which chronic diseases or risk factors are in scope — cardiovascular disease, diabetes, cancer (which sites?), COPD, obesity, tobacco, physical inactivity, nutrition?
2. What CDC cooperative agreements fund the program (1305 State and Local Public Health Actions, 1815 Tobacco Control, 1817 Cancer Prevention)?
3. What are the program's required activities and performance measures per the cooperative agreement?
4. What population-level data sources are available — BRFSS, YRBSS, vital records, state cancer registry, hospital discharge/ED data, Medicaid claims?
5. What evidence-based interventions are currently implemented?
6. What clinical-community linkage partnerships exist (health systems, FQHCs, pharmacies, community organizations)?
7. What is the program's relationship with the state/local tobacco quitline?
8. What health equity focus areas have been defined for chronic disease programming?
...
- Smoke-free policies (workplaces, restaurants, bars, multi-unit housing) (Community Guide: recommended)
- Tobacco tax increases (Community Guide: recommended)
- Youth prevention: counter-marketing (Truth campaign model), retail licensure, tobacco 21 laws
- Health systems interventions: Ask-Advise-Refer clinical protocols, EHR-embedded tobacco screening

**Nutrition and physical activity**:
- Community-wide campaigns for physical activity (Community Guide: recommended)
- Built environment strategies: complete streets, bike/pedestrian infrastructure, park improvements
- Food environment strategies: healthy food procurement policies, food prescription programs, healthy corner store initiatives
...
- **Employers**: Implement worksite wellness policies (healthy food options, physical activity breaks, tobacco-free campus, lactation support).
...
- [ ] 6|18 Initiative high-burden conditions addressed where applicable (tobacco, blood pressure, diabetes, asthma, unintended pregnancy, healthcare-associated infections)

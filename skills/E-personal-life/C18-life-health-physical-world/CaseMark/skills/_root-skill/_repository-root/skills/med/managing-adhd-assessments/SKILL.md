...
1. What is the patient's age group? (child 6-11, adolescent 12-17, adult 18+) — default: assessment differs by age group
2. What is the referral source and reason? (parent concern, teacher concern, self-referral, primary care referral, academic accommodations request, workplace performance) — default: identify
3. Has the patient been previously diagnosed with ADHD? (new evaluation vs. re-evaluation) — default: new evaluation
4. Has the patient been on stimulant medication previously? (if so, document response) — default: obtain history
5. Are collateral informants available? (parents/caregivers for children; partner, parent, or employer for adults) — default: required for children, strongly recommended for adults
6. Are school or workplace records available? (report cards, IEPs, performance reviews) — default: request
7. Is neuropsychological testing available or indicated? — default: not required for all cases
8. Are there known co-occurring conditions? (anxiety, depression, SUD, learning disability, ASD, trauma) — default: screen
...
8. Easily distracted by extraneous stimuli (or unrelated thoughts in adults)
...
3. Runs about or climbs inappropriately (in adults, may be subjective restlessness)
...
**Adults:**
- **ASRS v1.1 (Adult ADHD Self-Report Scale):** WHO-developed screener. Part A (6 items) = screening; Part B (12 items) = supplementary. Score ≥4 on Part A suggests ADHD.
- **CAARS-2 (Conners Adult ADHD Rating Scales):** Self-report and observer forms. Norm-referenced T-scores with validity indices.
- **WURS (Wender Utah Rating Scale):** Retrospective childhood symptom assessment. Score ≥46 suggests childhood ADHD symptoms.
...
- Elementary school performance — request report cards with teacher comments (most revealing source)
...
- Family history of ADHD, learning disabilities, substance use disorders (strong genetic component — heritability ~75%)
...
- **Anxiety disorders (GAD):** Difficulty concentrating, restlessness — but anxiety-driven, episodic, associated with worry. Administer GAD-7.
- **Major Depressive Disorder:** Poor concentration, psychomotor changes, low motivation — but episodic, associated with mood change. Administer PHQ-9.
- **Bipolar Disorder:** Distractibility, talkativeness, increased activity — but episodic, associated with mood elevation or irritability, grandiosity, decreased sleep need.
- **PTSD / Trauma:** Hyperarousal, concentration difficulty, irritability — but associated with trauma exposure and re-experiencing/avoidance symptoms. Administer PCL-5.
- **Substance Use Disorders:** Cognitive impairment, impulsivity — screen with AUDIT and DAST-10. Assess whether ADHD symptoms predate substance use.
...
- **Personality Disorders (Borderline):** Impulsivity, emotional dysregulation, relationship instability — but identity disturbance, abandonment fear, and self-harm distinguish BPD.
...
1. Are all 9 inattention and 9 hyperactivity-impulsivity symptoms systematically assessed and documented?
2. Is evidence of childhood onset (before age 12) documented from history, records, or collateral?
3. Are symptoms confirmed in at least two settings with multi-informant data?
4. Is the differential diagnosis documented with systematic evaluation of each alternative explanation?
5. Are validated rating scale scores reported with normative interpretation?

---

## Quality Audit

- [ ] DSM-5-TR criteria assessed item-by-item with documentation
- [ ] At least one validated rating scale administered to patient
- [ ] At least one collateral informant rating scale obtained
- [ ] Evidence of childhood onset before age 12 documented
- [ ] Symptoms confirmed in two or more settings
- [ ] Functional impairment documented across domains
- [ ] Differential diagnoses systematically evaluated (anxiety, depression, bipolar, PTSD, SUD, sleep, thyroid)
- [ ] Comorbid conditions identified and documented
- [ ] Developmental and school history obtained
- [ ] Family history of ADHD documented
- [ ] PDMP queried if stimulant medication is recommended
- [ ] Presentation specifier and severity documented
- [ ] Treatment recommendations aligned with age-appropriate guidelines
- [ ] Academic/workplace accommodations addressed

---

## Guidelines

1. Never diagnose ADHD based solely on self-report or a single rating scale — multi-informant, multi-method assessment is the standard of care per APA and AACAP guidelines.
2. Always document evidence of childhood onset — adult-onset ADHD is not recognized in DSM-5-TR, and "late-onset" presentations should trigger evaluation for alternative diagnoses.
3. Screen for substance use disorders before prescribing stimulants — ADHD and SUD commonly co-occur, and stimulant diversion/misuse is a documented risk. Use PDMP.
4. Do not rely on behavioral observations during the office visit to rule out ADHD — a structured, novel, one-on-one setting may temporarily suppress ADHD symptoms.
5. In adults presenting for first-time ADHD evaluation, maintain high suspicion for stimulant-seeking behavior — but do not deny appropriate diagnosis and treatment based on this concern alone. Document the clinical reasoning for the diagnosis.
6. For children, obtain teacher rating scales before rendering a diagnosis — parent-only assessment is insufficient to establish cross-setting impairment.
7. Document the response to treatment using the same rating scales used for diagnosis — measurement-based care is the standard for ADHD management.
8. When ADHD co-occurs with other conditions, treat the most impairing condition first — but document the rationale for treatment sequencing.

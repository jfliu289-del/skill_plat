...
The Health in All Policies (HiAP) movement has expanded HIA practice beyond environmental health into housing, transportation, education, economic development, and criminal justice policy. The National Academies' 2011 report "Improving Health in the United States: The Role of Health Impact Assessment" established minimum practice standards. As of 2024, over 500 HIAs have been completed in the U.S., with increasing emphasis on health equity analysis as a core component.
---
...
1. What is the proposed decision (policy, project, or plan) being assessed?
2. Who is the decision-maker and what is the decision timeline?
3. What populations will be affected, and which subpopulations are most vulnerable?
4. Has a screening determination already been made that an HIA is warranted?
5. What health determinants are likely to be affected (air quality, housing, food access, physical activity, social cohesion, economic opportunity)?
6. What existing data sources are available for the affected community?
7. Is this a rapid HIA (desk-based, 4-8 weeks), intermediate HIA (some primary data, 3-6 months), or comprehensive HIA (extensive primary data, 6-18 months)?
8. What community engagement resources are available for participatory input?

### Required Documents

- Proposal documentation (project plans, policy drafts, zoning applications, environmental review documents)
- Demographic and health profile of the affected community (Census/ACS, vital records, BRFSS, County Health Rankings)
- CDC/ATSDR Social Vulnerability Index (SVI) for the affected geography
- Existing Environmental Impact Statement (EIS) or Environmental Assessment (EA) if applicable
- Prior HIAs conducted in the same jurisdiction or for similar proposals
- Health in All Policies framework adopted by the jurisdiction (if any)
- Stakeholder map identifying community organizations, advocacy groups, and affected residents
...
- **Health relevance**: Does the proposal have a plausible pathway to affecting health? Assess through a pathway diagram linking the proposal to intermediate determinants to health outcomes.
- **Decision relevance**: Is the decision still open? Can health information influence the outcome?
- **Added value**: Is health adequately addressed in existing review processes (EIA, regulatory review)? If not, HIA adds value.
- **Feasibility**: Are data, expertise, time, and budget sufficient for a credible assessment?
...
- **Baseline health profile**: Current prevalence, incidence, and distribution of relevant health outcomes in the affected population. Use BRFSS, vital records, hospital discharge data, and CDC WONDER.
- **Exposure assessment**: Quantify the expected change in exposure or health determinant resulting from the proposal. For air quality, use dispersion modeling (AERMOD) or health impact functions from EPA BenMAP-CE. For transportation, use traffic modeling and pedestrian injury data. For housing, use housing quality indices and displacement metrics.
- **Dose-response/effect estimation**: Apply published exposure-response relationships from peer-reviewed literature or systematic reviews. For PM2.5, use EPA's concentration-response functions for mortality and morbidity. For noise, use WHO Environmental Noise Guidelines.
- **Impact characterization**: Estimate the number of affected individuals and the magnitude and direction (positive or negative) of expected health changes. Express impacts quantitatively where possible (e.g., estimated additional asthma ED visits per year) and qualitatively where data are insufficient.
- **Equity analysis**: Assess whether impacts are distributed disproportionately across subpopulations by race/ethnicity, income, age, disability, or geography. Use CDC SVI to identify vulnerable census tracts.
- **Uncertainty analysis**: Characterize the confidence level for each impact estimate (high, moderate, low) based on evidence quality, model assumptions, and data gaps.


### Common HIA Quantitative Methods Reference
...
- For each identified negative impact, propose specific mitigation measures with expected effectiveness.
- For each identified positive impact, propose enhancement measures to maximize benefit.
- Prioritize recommendations by: health impact magnitude, feasibility, cost, equity benefit, and alignment with community priorities.
- Frame recommendations in actionable terms for the decision-maker (e.g., "Require MERV-13 filtration in residential units within 500 feet of the freeway" rather than "Improve air quality").
- Identify which recommendations can be incorporated into the proposal design, which require separate policy action, and which need ongoing monitoring.
...
## Checkpoint B — HIA Completion Review
...
- Economic impacts are health impacts. Changes in employment, income, housing affordability, and displacement have well-documented effects on health outcomes. Include economic determinants in every HIA scope, not just environmental exposures.
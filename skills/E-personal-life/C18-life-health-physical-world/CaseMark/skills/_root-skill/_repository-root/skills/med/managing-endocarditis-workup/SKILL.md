...
1. What is the clinical suspicion for endocarditis — low, intermediate, or high? (default: "Clinical suspicion not graded")
2. Have blood cultures been drawn? How many sets, timing, and were antibiotics given prior? (default: "Blood culture status unknown")
3. Does the patient have a prosthetic valve, intracardiac device (pacemaker/ICD), or prior endocarditis? (default: "No prosthetic material")
4. What are the current fever pattern, inflammatory markers (CRP, ESR, WBC), and blood culture results? (default: "Not yet available")
5. Has echocardiography been performed (TTE and/or TEE)? (default: "Echo not yet performed")
6. Are there signs of embolic phenomena — stroke, splenic infarct, Janeway lesions, Osler nodes, splinter hemorrhages? (default: "Embolic workup not performed")
7. What is the suspected portal of entry — dental, IV drug use, nosocomial, urologic, unknown? (default: "Source unknown")
8. Is the patient hemodynamically stable? (default: "Hemodynamic status not documented")
...
| Category | Criteria |
|----------|---------|
| Definite IE (pathologic) | Microorganisms on histology/culture of vegetation or abscess |
| Definite IE (clinical) | 2 major; or 1 major + 3 minor; or 5 minor |
| Possible IE | 1 major + 1 minor; or 3 minor |
| Rejected | Firm alternative diagnosis; resolution with ≤ 4 days antibiotics; no pathologic evidence at surgery/autopsy |
...
| Scenario | Recommended Imaging |
|----------|-------------------|
| Native valve, good acoustic windows | TTE first; TEE if TTE negative but clinical suspicion remains |
| Prosthetic valve | TEE required (TTE sensitivity < 50% for prosthetic IE) |
| Intracardiac device | TEE required (assess lead vegetations) |
| TTE positive for vegetation | TEE still recommended (assess complications: abscess, fistula, perforation) |
| S. aureus bacteremia | TEE recommended even if TTE negative (high IE risk) |
...
|----------|-------------|-----------------|
| Viridans streptococci (penicillin-susceptible) | 4 weeks IV PCN/ceftriaxone | 6 weeks |
| Enterococcus (ampicillin-susceptible) | 4–6 weeks ampicillin + ceftriaxone (or gentamicin) | 6 weeks |
| MSSA | 6 weeks nafcillin/oxacillin | 6+ weeks nafcillin + rifampin + gentamicin |
| MRSA | 6 weeks vancomycin (or daptomycin) | 6+ weeks vancomycin + rifampin + gentamicin |

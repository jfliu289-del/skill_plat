...
1. Which infectious diseases are in scope — STIs (chlamydia, gonorrhea, syphilis), HIV, TB, hepatitis B/C, vaccine-preventable diseases, foodborne/waterborne, healthcare-associated infections, or emerging infections?
2. What CDC cooperative agreements fund the program(s)?
3. What clinical services does the health department provide directly (STI clinic, TB clinic, HIV testing, immunizations)?
4. What surveillance systems are in use (NNDSS, ELR, HIV Surveillance System/eHARS, NTSS, NEDSS)?
5. What laboratory capacity exists — public health lab, commercial lab partnerships, antimicrobial susceptibility testing, molecular typing?
6. What treatment access mechanisms are available — 340B drug pricing, ADAP (AIDS Drug Assistance Program), Ryan White, Medicaid, uninsured/underinsured programs?
7. What is the jurisdiction's legal framework for partner notification, mandatory treatment, and quarantine?
8. What linkage-to-care infrastructure exists — patient navigation, community health workers, care coordination?
...
- Track treatment outcomes: completion rate target ≥ 93% for drug-susceptible TB.

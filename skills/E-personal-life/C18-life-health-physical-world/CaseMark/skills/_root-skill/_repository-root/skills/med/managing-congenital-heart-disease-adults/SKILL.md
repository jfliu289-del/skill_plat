...
1. What is the specific congenital heart defect? (default: "Lesion not specified")
2. Has the defect been repaired surgically or percutaneously? What type of repair and when? (default: "Repair status unknown")
3. What is the current functional status (NYHA class)? (default: "Functional class not assessed")
4. What is the current anatomy — chamber sizes, LVEF, RVEF, valve function, residual shunts? (default: "Current imaging not provided")
5. Are there arrhythmias documented or suspected? (default: "Arrhythmia status unknown")
6. Is the patient female of childbearing potential? Is pregnancy planned? (default: "Pregnancy status not assessed")
7. Has the patient been seen at an ACHD-accredited center? (default: "ACHD center involvement not documented")
8. What is the current medication list and endocarditis prophylaxis status? (default: "Medications not reviewed")

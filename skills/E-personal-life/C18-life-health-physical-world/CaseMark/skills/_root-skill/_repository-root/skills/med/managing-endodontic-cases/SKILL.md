...
### Intake Questions
1. Can the patient localize the pain to a specific tooth, or is it diffuse?
2. What triggers the pain — cold, hot, biting, spontaneous, positional?
3. How long does the pain last after stimulus removal (seconds vs. minutes vs. continuous)?
4. Is there swelling, and if so, is it localized (vestibular abscess) or diffuse (cellulitis)?
5. Has the patient experienced trauma to the area, and if so, when?
6. Has the tooth had previous endodontic treatment?
7. Is the patient taking bisphosphonates (risk for MRONJ with surgical procedures)?

---

## Step 1 — Diagnostic Testing Protocol
...
- **Reversible pulpitis**: Exaggerated but brief response to cold (resolves within 1–2 seconds of stimulus removal); no spontaneous pain; indicates inflamed pulp that can recover if irritant is removed
- **Symptomatic irreversible pulpitis**: Lingering response to cold (> 10 seconds), spontaneous pain, pain to heat, may be exacerbated by positional change; pulp cannot recover — RCT or extraction indicated
...
## Step 3 — AAE Periapical Diagnosis
...
## Step 4 — Treatment Decision and Planning

Determine treatment approach based on diagnosis, restorability, and strategic value.

- **Restorability assessment**: Evaluate remaining tooth structure; determine if post-endodontic restoration (core buildup + crown) is feasible; ferrule effect requires minimum 1.5–2 mm of sound supracrestal tooth structure circumferentially
...
- **Referral criteria**: Calcified canals, complex anatomy (C-shaped canals, dens invaginatus), retreatment with separated instruments, surgical endodontics, teeth requiring CBCT evaluation — refer to endodontist

---

## Step 5 — Treatment Documentation
...
- **Irrigation protocol**: Solutions used (NaOCl concentration typically 2.5–6%, EDTA 17%, CHX 2% if used), delivery method (syringe with side-vented needle, EndoActivator, passive ultrasonic irrigation), volume per canal
- **Obturation**: Technique (warm vertical condensation, lateral condensation, single cone with bioceramic sealer), master cone size and taper, sealer type, quality assessment (radiographic fill to within 0–2 mm of apex, dense fill without voids)
- **Intraoperative complications**: Ledge formation, perforation (location, size, repair material — MTA or bioceramic putty), separated instrument (type, location in canal, management decision), hemorrhage control

---

## Step 6 — Outcome Assessment and Follow-Up
...
## Checkpoint B — Case Documentation Review

- [ ] Pulpal diagnosis assigned using AAE terminology
- [ ] Periapical diagnosis assigned using AAE terminology
- [ ] All diagnostic tests documented with results (cold, EPT, percussion, palpation) including control teeth
- [ ] Pre-operative radiograph in chart with interpretation
- [ ] Restorability and strategic value assessed before treatment
- [ ] Working lengths recorded for all canals
- [ ] Instrumentation technique and master apical sizes documented
- [ ] Irrigation protocol documented with solutions and delivery method
- [ ] Obturation technique and quality assessment documented
- [ ] Post-operative radiograph in chart showing fill quality
- [ ] Follow-up schedule established and communicated to patient
...
| 7 | Obturation quality | Post-operative radiograph shows fill 0–2 mm from apex without voids |
...
- Always use AAE standardized pulpal and periapical diagnostic terminology — never use informal terms ("hot tooth," "dying nerve," "infected") in clinical documentation
...
- MB2 canal must be actively sought in all maxillary molars — document the search effort and outcome regardless of whether the canal is found
- CBCT is indicated per AAE/AAOMR when 2D imaging is inconclusive for canal anatomy, resorption, root fracture, or periapical pathology characterization — document the specific clinical question the CBCT will answer
- Irrigation is as important as instrumentation — document solutions, concentrations, volumes, and activation method

...
1. **Classify the asset type and revenue model**
...
2. **Analyze historical traffic or ridership**
...
3. **Evaluate fare/toll structure and revenue sensitivity**
...
4. **Benchmark operating efficiency**
...
5. **Review capital expenditure and lifecycle obligations**
...
6. **Stress-test the financial model**
...
7. **Assess ramp-up and demand risk (greenfield assets)**

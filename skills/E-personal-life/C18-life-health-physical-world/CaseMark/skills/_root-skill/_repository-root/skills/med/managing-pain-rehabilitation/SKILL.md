...
- Current medication list with opioid details (morphine milligram equivalents — MME)
...
## Step 1 — Perform Comprehensive Pain and Function Assessment
...
- **Pain Catastrophizing Scale (PCS):** 13 items, 0-52; score ≥30 = clinically significant catastrophizing
- **Fear-Avoidance Beliefs Questionnaire (FABQ):** Physical activity subscale ≥15 or work subscale ≥34 = elevated fear-avoidance
- **PHQ-9:** Depression screening; score ≥10 indicates moderate depression requiring intervention
- **GAD-7:** Anxiety screening; score ≥10 indicates moderate anxiety
- **Opioid Risk Tool (ORT):** Score ≥8 = high risk for opioid misuse
...
## Step 2 — Establish the Functional Restoration Framework
...
## Step 3 — Implement Multidisciplinary Interventions
...
- Manual therapy: As adjunct only — do not create passive treatment dependence
...
## Step 4 — Track Outcomes with Pain and Function Measures
...
## Step 5 — Plan Discharge and Long-Term Self-Management
...
- [ ] Biopsychosocial assessment complete (pain, function, psychological, social factors)
- [ ] Functional restoration framework documented (quota-based, not pain-contingent)
- [ ] Multidisciplinary team composition and roles documented
- [ ] Exercise prescription uses quota-based progression with specific targets
- [ ] Psychological screening scores documented with referral if indicated
- [ ] Opioid status documented at intake and each reassessment
- [ ] Outcomes focus on function over pain intensity
- [ ] Patient education in pain neuroscience documented
- [ ] Self-management and flare-up plan created
- [ ] Return-to-work status documented with specific physical demand levels

---

## Quality Audit

- [ ] Pain assessment uses standardized instruments (NPRS, BPI) not just subjective report
- [ ] Psychosocial measures (PCS, FABQ, PHQ-9) scored and interpreted
- [ ] ODI/NDI/DASH used for region-specific disability measurement
- [ ] Exercise progression is quota-based with documented weekly targets
- [ ] Function, not pain, is the primary documented outcome
- [ ] Multidisciplinary notes are coordinated (consistent messaging across disciplines)
- [ ] Opioid MME calculated and tracked across program
- [ ] All [VERIFY] flags resolved or escalated to pain specialist
- [ ] Program meets CARF interdisciplinary pain rehabilitation program standards if applicable
- [ ] Documentation demonstrates skilled need distinct from general exercise

---

## Guidelines

- Chronic pain rehabilitation uses the biopsychosocial model — biological, psychological, and social factors all require assessment and intervention
- Function is the primary outcome; pain intensity reduction is secondary and should not be the sole measure of success
- Never reinforce pain behavior with documentation — document functional achievements alongside pain reports
- Quota-based exercise is non-negotiable in functional restoration — pain-contingent activity perpetuates disability
...
- Fear-avoidance beliefs are the strongest predictor of chronic pain disability — screen every patient
- Graded exposure requires collaboration with psychology — do not attempt without training
- Workers compensation chronic pain cases require FCE and return-to-work documentation per jurisdictional guidelines
- Pain neuroscience education (PNE) has Level 1 evidence for reducing pain catastrophizing — include in every chronic pain program
- Do not promise pain elimination — set expectations for improved function, coping, and quality of life

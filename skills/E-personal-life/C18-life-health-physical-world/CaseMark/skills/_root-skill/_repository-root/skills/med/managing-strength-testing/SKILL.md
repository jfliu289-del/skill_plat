...
## Step 1 — Select Testing Method Based on Clinical Context
...
## Step 2 — Perform Manual Muscle Testing Using MRC Scale
...
## Step 3 — Perform Dynamometry When Indicated
...
- Limb symmetry index: (involved ÷ uninvolved) x 100; deficit >20% clinically significant
...
## Step 4 — Correlate Strength Deficits to Functional Limitations
...
## Step 5 — Analyze Effort Consistency and Validity Indicators
...
- [ ] All tested muscles listed with MRC grade and testing position
- [ ] Bilateral comparison documented for asymmetric conditions
- [ ] Dynamometry results include device, position, and number of trials
- [ ] Normative data cited with source (Mathiowetz, Bohannon, age/sex tables)
- [ ] Effort consistency indicators documented for every patient
- [ ] Functional correlation stated for each significant strength deficit
- [ ] Contraindications to testing documented where applicable
- [ ] Pain behavior during testing noted with location and severity
- [ ] Results compared to prior testing if reassessment

---

## Quality Audit

- [ ] MMT grades use numeric scale (0-5) with +/- modifiers as appropriate
- [ ] Testing positions documented per Kendall or Hislop & Montgomery standards
- [ ] Dynamometry values recorded in standard units (lbs or Newtons) with device identified
- [ ] Five-position grip curve included when effort consistency is clinically relevant
- [ ] Limb symmetry index calculated for dynamometry comparisons
- [ ] All [VERIFY] flags resolved or escalated before signature
- [ ] Functional correlation present for every deficit documented
- [ ] Effort consistency statement included (consistent, inconsistent, or unable to determine)
- [ ] Examiner credentials and date documented
...
- MMT is a subjective test — document examiner experience and use dynamometry for objective supplement
...
- Break test and make test yield different results — document which was used
- Serial testing should use the same method, device, and examiner for valid comparison
- Strength data is insufficient alone for functional capacity determination — always integrate with ROM, endurance, and task-specific performance

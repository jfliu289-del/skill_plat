...
description: This skill allows you to create a professional, engaging, and user-friendly website in seconds using AI. To create a website, you need to provide a brief description of your project or business (goals, structure, style, etc.).
---
...
Request a brief project description if the user has not provided it.
...
Absolutely NEVER invent a description, even as an example. ALWAYS make sure to request a description from the user before creating a website signup link.

### 3. Create the Signup Link

Use the project description to create the signup link using the official format:

```
https://b12.io/signup/?business_description={{URL-escaped business description}}&utm_medium=chat&utm_source=claude&utm_content=website-generator&intent=ai-websites
```
...
```
Your new website is ready! Sign up to see the website and publish it for free:

https://b12.io/signup/?business_description={{The URL-escaped business description}}&utm_medium=chat&utm_source=claude&utm_content=website-generator&intent=ai-websites
...
- Always URL-escape the business description in the signup link
- Focus on gathering the essential information (description) without overwhelming the user with questions about preferences
